...
function listar2()
{
	tabla2=$('#tbllistado2').dataTable(
	{
		...
		"ajax":
				{
					url: '../ajax/trainers.php?op=listar2',
					type : "get",
					dataType : "json",						
					error: function(e){
...
function guardaryeditar2(e)
{
	...
	$.ajax({
		url: "../ajax/trainers.php?op=guardaryeditar2",
		type: "POST",
		data: formData,
		contentType: false,
		processData: false,
...
{
	$.post("../ajax/trainers.php?op=mostrar2",{id_trainer : id_trainer}, function(data, status)
	{
        ...
        $("#im5").show();
        $("#im5").attr("src","../public/images/team/"+data.foto);
        $("#ia5").val(data.foto); 
	})
}
